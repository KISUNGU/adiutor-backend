...
(async () => {
  try {
    const res = await axios.put('http://localhost:4000/api/mails/incoming/45/archive', { comment: 'Test archivage automatique via script' }, { headers: { Authorization: `Bearer ${token}` }, timeout: 30000 });
